...
import { useRef, useCallback, useMemo, useEffect, createContext as createContext$1, useContext, useImperativeHandle, useState, useLayoutEffect, Fragment as Fragment$1, Suspense } from "react";
...
import { Vector3, QuadraticBezierCurve3, LineCurve3, Plane, Vector2, Color, DoubleSide, MathUtils, Raycaster, Sphere as Sphere$1, Box3, Spherical, Matrix4, Quaternion, Vector4, MOUSE, TextureLoader, LinearFilter, TubeGeometry, Euler, BoxGeometry, CylinderGeometry, BufferAttribute, Mesh, Scene } from "three";
...
const Edge$1 = ({
  ...
  const arrowComponent = useMemo(
    () => arrowPlacement !== "none" && /* @__PURE__ */ jsx(
      ...
      {
        animated,
        color: isSelected || active || isActive ? theme.arrow.activeFill : fill ? fill : theme.arrow.fill,
        length: arrowLength,
        opacity: selectionOpacity,
  ...
  const labelComponent = useMemo(
    () => labelVisible && label && /* @__PURE__ */ jsx(a.group, { position: labelPosition, children: /* @__PURE__ */ jsx(
      Label,
      {
        ...
        color: isSelected || active || isActive ? theme.edge.label.activeColor : labelColor ? labelColor : theme.edge.label.color,
        opacity: selectionOpacity,
  ...
  return /* @__PURE__ */ jsxs("group", { children: [
    /* @__PURE__ */ jsx(
      Line,
      {
        curveOffset,
        animated,
        color: isSelected || active || isActive ? theme.edge.activeFill : fill ? fill : theme.edge.fill,
        curve,
        curved,
        id,
        opacity: selectionOpacity,
